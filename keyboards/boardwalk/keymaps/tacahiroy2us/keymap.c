...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_COLEMAK] = LAYOUT_ortho_5x14(
  KC_GRV,     KC_1,  KC_2, KC_3,    KC_4,    KC_5,  KC_5,     KC_6,   KC_7,  KC_8,    KC_9,    KC_0,    KC_MINS, KC_BSPC, \
  KC_TAB,     KC_Q,  KC_W, KC_F,    KC_P,    KC_G,  KC_G,     KC_J,   KC_L,  KC_U,    KC_Y,    KC_SCLN, KC_BSLS, KC_ESC,  \
  CTL_X(ESC), KC_A,  KC_R, KC_S,    KC_T,    KC_D,  KC_D,     KC_H,   KC_N,  KC_E,    KC_I,    KC_O,    KC_QUOT, KC_ENT,  \
  KC_LSFT,    KC_Z,  KC_X, KC_C,    KC_V,    KC_B,  KC_B,     KC_K,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RSFT, \
  XXXXXXX,    KC_NO, MOUS, KC_LGUI, KC_LALT, LOWER, KC_SPC,   KC_SPC, RAISE, KC_LEFT, KC_DOWN, KC_MEH,  KC_RCTL, XXXXXXX  \
 ),
