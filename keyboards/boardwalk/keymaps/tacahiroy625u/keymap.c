...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_COLEMAK] = LAYOUT_625u_arrow(
    ...
    CTL_X(ESC), KC_A,    KC_R,    KC_S,  KC_T,  KC_D,  KC_H, KC_N,  KC_E,    KC_I,   KC_O,    KC_QUOT, KC_ENT,  KC_LGUI,
    KC_LSFT,    KC_Z,    KC_X,    KC_C,  KC_V,  KC_B,  KC_K, KC_M,  KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP,   KC_PGDN,
    MOUS,       KC_LALT, LOWER,                   RS_X(SPC),                 RAISE,  KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
  ),
 ...
 [_LOWER] = LAYOUT_625u_arrow(
    W_IME,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,
    MC_EXPS, _______, _______, W_IME,   _______, _______, _______, TM_PREV, KC_BSPC, TM_NEXT, KC_PIPE, _______, _______, KC_PIPE,
    _______, _______, _______, W_SSHOT, MOUS,    _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, TM_SSH,  _______, _______, _______,
    _______, W_QUIT,  _______, _______, _______, _______, _______, KC_HOME, KC_END,  _______, TM_LSTS, _______, TOP,     BOTTOM,
    _______, _______, _______,                         _______,                      _______, _______, _______, _______, _______
  ),
