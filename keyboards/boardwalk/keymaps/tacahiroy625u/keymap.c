...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_LOWER] = LAYOUT_625u_arrow(
    ...
    M_EXPS,  XX_WIN,  XX_TAB,  _______, _______, _______, _______, TM_PREV, KC_BSPC, TM_NEXT, KC_PIPE, _______, _______, _______,
    _______, KC_ESC,  MOUS,    W_SSHOT, KC_F5,   KC_F3,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, TM_SSH,  _______, _______, _______,
    _______, _______, _______, _______, _______, TOP,     BOTTOM,  KC_HOME, KC_END,  KC_SPC,  TM_LSTS, _______, _______, _______,
    _______, _______, _______,                      KC_HENK,                         _______, _______, _______, _______, _______

  ),

 [_RAISE] = LAYOUT_625u_arrow(
    _______, _______, _______, KC_F3,   _______, KC_F5,   WS_LEFT, WS_RGHT, _______, _______, _______, _______, _______, XX_WIN,
