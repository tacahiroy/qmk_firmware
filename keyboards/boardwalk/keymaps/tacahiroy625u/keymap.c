...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_LOWER] = LAYOUT_625u_arrow(
    ...
    _______, _______, _______, _______, _______, TOP,     BOTTOM,  KC_HOME, KC_END,  KC_SPC,  TM_LSTS, _______, KC_PGUP, KC_PGDN,
    _______, _______, _______,                      KC_HENK,                         _______, _______, _______, KC_VOLU, KC_VOLD
  ),
