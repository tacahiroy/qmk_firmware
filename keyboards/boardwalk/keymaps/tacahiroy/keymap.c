...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_COLEMAK] = LAYOUT_ortho_hhkb(
  ...
  KC_LCTL,  KC_A,  KC_R,     KC_S,     KC_T,   KC_D,  KC_PGUP,  KC_PGDN,  KC_H,  KC_N,   KC_E,     KC_I,        KC_O,     KC_ENT,  \
 ...
 [_COLEMAK2] = LAYOUT_ortho_hhkb(
  KC_GRV,   KC_1,  KC_2,     KC_3,     KC_4,   KC_5,  KC_PLUS,  KC_UNDS,  KC_6,  KC_7,   KC_8,     KC_9,        KC_0,     KC_BSPC, \
  KC_TAB,   KC_Q,  KC_W,     KC_F,     KC_P,   KC_G,  KC_HOME,  KC_END,   KC_J,  KC_L,   KC_U,     KC_Y,        KC_SCLN,  KC_QUOT, \
  KC_LCTL,  KC_A,  KC_R,     KC_S,     KC_T,   KC_D,  KC_PGUP,  KC_PGDN,  KC_H,  KC_N,   KC_E,     KC_I,        KC_O,     KC_ENT,  \
  KC_LSFT,  KC_Z,  KC_X,     KC_C,     KC_V,   KC_B,  KC_EQL,   KC_MINS,  KC_K,  KC_M,   KC_COMM,  KC_DOT,      KC_SLSH,  KC_RSFT, \
            MOUS,  KC_LGUI,  KC_LALT,  LOWER,     KC_ESC,            KC_SPC,     RAISE,  KC_MINS,  MEH_X(BSLS), KC_RCTL            \
 ),
 ...
 [_LOWER] = LAYOUT_ortho_hhkb(
  ...
  _______, _______, _______, W_SSHOT, MOUS,    W_QUIT,  _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, TM_SSH,  TOP,     \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_END,  W_IME,   _______, BOTTOM,  \
           _______, _______, _______, _______,    _______,           _______,      _______, _______, _______, _______           \
 ),
 ...
 [_RAISE] = LAYOUT_ortho_hhkb(
  ...
  _______,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, TOP,     BOTTOM,  KC_CIRC, KC_AMPR, KC_ASTR, FX_NEXT, _______, VMW_REL, \
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case COLEMAK2:
      if (record->event.pressed) {
        print("mode just switched to Colemak2 and this is a huge string\n");
