...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_LOWER] = LAYOUT_ortho_hhkb(
  ...
  _______, _______, _______, W_IME,   _______, _______, _______, _______, V_ALTB,  TM_PREV, KC_BSPC, TM_NEXT, _______, KC_PIPE, \
  _______, _______, _______, W_SSHOT, MOUS,    _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, TM_SSH,  _______, \
  _______, W_QUIT,  _______, _______, _______, TOP,     _______, _______, BOTTOM,  KC_HOME, KC_END,  _______, TM_LSTS, _______, \
           _______, _______, _______, _______,    _______,           _______,      _______, _______, _______, _______           \
 ),
