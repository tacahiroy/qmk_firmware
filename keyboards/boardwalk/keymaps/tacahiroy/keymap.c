...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_LOWER] = LAYOUT_ortho_hhkb(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, V_ALTB,  TM_PREV, TM_PWIN, TM_NEXT, _______, KC_PIPE, \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_END,  _______, _______, _______, \
           _______, _______, _______, _______,    _______,           _______,      _______, W_IME,   _______, _______           \
 ),
