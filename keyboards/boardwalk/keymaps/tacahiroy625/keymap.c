...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_COLEMAK] = LAYOUT_625u_arrow(
    ...
    KC_LSFT, LW_X(Z), KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_PGDN, 
    LOWER,   KC_LGUI, KC_LALT,                        KC_SPC,                        RAISE,   KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT  
  ),
 ...
 [_QWERTY] = LAYOUT_625u_arrow(
    ...
    _______, KC_LGUI, KC_LALT,                        KC_SPC,                        KC_RALT, KC_RCTL, _______, _______, _______ 
  ),

 [_LOWER] = LAYOUT_625u_arrow(
    MC_EXPS, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MSTP, KC_MPLY,
    _______, _______, _______, _______, _______, _______, _______, TM_PREV, FX_NEXT, TM_NEXT, _______, KC_MUTE, KC_VOLD, KC_VOLU,
    _______, _______, _______, W_SSHOT, MOUS,    _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, _______, KC_HOME,
    _______, _______, _______, _______, _______, _______, W_IME,   KC_HOME, KC_END,  _______, _______, _______, _______, KC_END,
 ...
 [_RAISE] = LAYOUT_625u_arrow(
    ...
    _______, W_QUIT,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, VMW_REL,
    _______, _______, KC_EQL,  KC_PLUS, KC_UNDS, _______, _______, _______, _______, _______, _______, _______, _______, TOP,
    _______, _______, CUT,     COPY2,   PASTE2,  _______, _______, _______, _______, _______, _______, _______, _______, BOTTOM,
    _______, _______, _______,                        _______,                       _______, _______, _______, _______, _______ 
 ),

 [_MOUS] = LAYOUT_625u_arrow(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, KC_WH_U, _______, KC_WH_D, _______, _______, _______, _______,
