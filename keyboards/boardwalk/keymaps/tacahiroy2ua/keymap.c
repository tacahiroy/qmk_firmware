...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_LOWER] = LAYOUT_2u_arrow(
    ...
    _______, _______, _______, _______, _______, _______, TM_LSTS, TM_PREV, KC_BSPC, TM_NEXT, _______, _______, _______, KC_PIPE,
    _______, _______, _______, W_SSHOT, MOUS,    _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, TM_SSH,  TOP,     _______, _______,
    _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_END,  W_IME,   _______, BOTTOM,  _______, _______,
    _______, _______, _______, _______,          _______, _______,          _______, _______, _______, _______, _______, _______
  ),
