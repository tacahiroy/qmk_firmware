...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_LOWER] = LAYOUT_ortho_7u(
    ...
    MC_EXPS, _______, XX_TAB,  _______, _______, _______, _______, TM_PREV, KC_BSPC, TM_NEXT, KC_PIPE, _______, _______, KC_PIPE,
 ...
 [_RAISE] = LAYOUT_ortho_7u(
    _______, _______, _______, _______, _______, _______, W_LFT_D, W_RGT_D, _______, _______, _______, _______, _______, XX_WIN,
    ...
    _______, KC_UNDS, CUT,     COPY,    PASTE2,  KC_LCBR, KC_RCBR, _______, _______, _______, _______, _______, _______, _______,
             _______, _______,                       _______,                                          _______, _______
 ),
