...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_COLEMAK] = LAYOUT_ortho_5x14(
    ...
    MOUS,       KC_LGUI, KC_LALT, LOWER,  LW_X(ESC), LW_X(ESC), KC_SPACE,  RAISE, RAISE,   KC_MEH, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
 ),
 ...
 [_LOWER] = LAYOUT_ortho_5x14(
    ...
    _______, _______, _______, W_IME,   _______, _______, _______, TM_PREV, KC_BSPC, TM_NEXT, KC_PIPE, _______, _______, KC_PIPE,
