...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT_alice_split_bs(
    KC_ESC,    KC_GRV,     KC_1,   KC_2,   KC_3,      KC_4,    KC_5,   KC_EQL,  KC_6,      KC_7,    KC_8,   KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS,
  ...
  [_LOWER] = LAYOUT_alice_split_bs(
    ...
    KC_VOLU,   M_EXPS,  XX_WIN,  XX_TAB,  _______, _______, _______,           _______, TM_PREV, KC_BSPC, TM_NEXT, KC_PIPE, KC_MPRV, KC_MNXT, KC_DEL,
  ...
  [_RAISE] = LAYOUT_alice_split_bs(
    ...
    KC_MUTE,   _______, _______, KC_EQL,  KC_PLUS, KC_LPRN, KC_LBRC,            KC_RBRC, KC_RPRN, KC_DEL,  KC_BSLS, _______, _______, _______,
               _______, KC_UNDS, CUT,     COPY2,   PASTE2,  KC_LCBR,            _______, KC_RCBR, KC_PGUP, KC_PGDN, _______, _______, _______, QK_BOOT,
               _______,                   _______, _______, _______,            _______, _______,                                              _______
  ),
