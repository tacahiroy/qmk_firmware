...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_alice_split_bs(
    ...
    KC_VOLD,   _______, _______, _______, _______, _______, _______,           KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, TM_SSH,  _______,          _______,
  ...
  [_MOUS] = LAYOUT_alice_split_bs(
    ...
    EPRM,      _______, _______, _______, KC_MS_U,  _______, KC_BTN1,            KC_BTN2, _______, _______, _______, _______, _______, _______, _______,
