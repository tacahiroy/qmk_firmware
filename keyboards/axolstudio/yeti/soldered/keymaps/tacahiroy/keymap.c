...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_alice_split_bs(
    ...
    KC_VOLU,   M_EXPS,  XX_WIN,  XX_TAB,  KC_GRV,  _______, _______,           _______, TM_PREV, KC_BSPC, TM_NEXT, KC_PIPE, KC_MPRV, KC_MNXT, KC_DEL,
    KC_VOLD,   _______, KC_ESC,  MOUS,    W_SSHOT, KC_F5,   KC_F3,             KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, TM_SSH,  _______, _______,
               _______, _______, _______, _______, _______, TOP,               _______, BOTTOM,  KC_HOME, KC_END,  _______, TM_LSTS, _______, KC_PGUP,
