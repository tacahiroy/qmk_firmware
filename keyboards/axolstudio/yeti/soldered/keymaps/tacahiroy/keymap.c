...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_alice_split_bs(
    ...
    KC_MPRV,   W_WLST,  XX_WIN,  XX_TAB,  PS_DETM, PS_WINM, PS_IMER,           TM_SLST, TM_PREV, TM_WLST, TM_NEXT, KC_PIPE, KC_VOLD, KC_VOLU, KC_DEL,
  ...
  [_MOUS] = LAYOUT_alice_split_bs(
    ...
    EPRM,      _______, _______, _______, _______, _______, _______,            _______, MS_BTN1, _______, MS_BTN2, _______, _______, KC_VOLD, KC_VOLU,
