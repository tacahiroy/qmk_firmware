...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
    ...
    SC_LSPO,  KC_Z,     KC_X,   KC_C,   KC_V,   KC_B,      KC_K,   KC_M,   KC_COMM,  KC_DOT,  KC_SLSH,  SC_RSPC,  KC_LGUI,
    KC_LALT,  XXXXXXX,  LOWER,                  RS_X(SPC),                                    KC_RCTL,  XXXXXXX,  KC_RALT
  ),

  [_NORMAN] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
  ...
  [_BS2U] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
  ...
  [_QWERTY] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  ...
  [_LOWER] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
    KC_GRV,  _______, _______, _______, _______, _______, _______, C_LEFT,  C_RIGHT, _______, _______, _______, _______, _______, _______,
    W_WLST,  _______, XX_TAB,  KC_MEH,  KC_CAPS, _______, SK_KANA, TM_PREV, TM_WLST, TM_NEXT, KC_PIPE, _______, CW_TOGG, KC_DEL,
  ...
  [_RAISE] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
    ...
    ADJUST,  KC_UNDS, KC_EQL,  KC_PLUS, KC_LPRN, KC_LBRC, KC_RBRC, KC_RPRN, KC_DEL,  KC_BSLS, _______, _______, _______,
    _______, _______, CUT,     COPY2,   PASTE2,  KC_LCBR, KC_RCBR, KC_PGUP, KC_PGDN, _______, _______, _______, QK_BOOT,
    _______, _______, _______,                   _______,                            _______, _______, _______
  ),

  [_MOUS] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
  ...
  [_ADJUST] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
