...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_60_tsangan_split_bs_rshift(
    KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_CAPS, KC_CAPS,
  ...
  [_RAISE] = LAYOUT_60_tsangan_split_bs_rshift(
    _______, _______, _______, KC_F3,   _______, KC_F5,   _______, C_LEFT,  C_RIGHT, _______, _______, _______, _______, XX_WIN,  XX_WIN,
