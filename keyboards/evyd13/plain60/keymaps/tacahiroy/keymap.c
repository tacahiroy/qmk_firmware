...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT(
    ...
    KC_TAB,  KC_Q,    KC_W,   KC_F,   KC_P,   KC_G,   KC_Y,   KC_L,   KC_U,   KC_Y,    KC_SCLN, KC_LBRC, KC_RBRC, KC_BSLS,
    KC_LCTL, KC_A,    KC_R,   KC_S,   KC_T,   KC_D,   KC_H,   KC_N,   KC_E,   KC_I,    KC_O,    KC_QUOT, _______, KC_ENT,
    KC_LSFT, _______, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_K,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RGUI,
    _______, KC_LALT, LOWER,                      RS_X(SPC),                           RAISE,   KC_RCTL, _______, _______
  ),
