...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_RAISE] = LAYOUT_default(
        W_S_WIN,  KC_TILD,  KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,   KC_PERC,  KC_CIRC,  KC_AMPR,  KC_ASTR,  FX_NEXT,  KC_0,     _______,  _______,  XX_WIN,
        _______,  _______,  KC_EQL,   KC_PLUS,  KC_LPRN,  KC_LBRC,  KC_RBRC,  KC_RPRN,  KC_DEL,   KC_BSLS,  MIC_TGL,  _______,  _______,  RAL_RCT,
        _______,  _______,  XXXXXXX,  _______,  CUT,      COPY2,    PASTE,    KC_LCBR,  KC_RCBR,  KC_PGUP,  KC_PGDN,  _______,  _______,  _______,  _______,
        _______,            _______,  _______,        _______,             _______,     _______,            _______
    ),

	[_MOUS] = LAYOUT_default(
        QK_BOOT,  _______,  _______,  _______,  KC_MS_U,  KC_BTN1,  KC_BTN2,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,  KC_MS_L,  KC_MS_D,  KC_MS_R,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
	...
	[_MOVE] = LAYOUT_default(
        ...
        _______,  _______,  KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   _______,  _______,  _______,  _______,  _______,
        _______,  _______,  XXXXXXX,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,            _______,  _______,        _______,             _______,     _______,            _______
    ),
