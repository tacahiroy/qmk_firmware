...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  M_EXPS,  XX_WIN,  XX_TAB,  KC_MS_U, W_SNIP, KC_BTN1, KC_BTN2, TM_PREV, KC_BSPC, TM_NEXT, KC_PIPE, KC_F12,
  _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, TM_SSH,  _______,
  _______, _______, _______, _______, _______, TOP,     BOTTOM,  KC_HOME, KC_END,  _______, TM_LASS, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),

[_RAISE] = LAYOUT_preonic_grid(
  _______, _______, _______, KC_F3,   _______, KC_F5,   _______, _______, _______, _______, _______, XX_WIN,
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______,
  _______, CADEL,   _______, _______, _______, DB_TOGG, _______, _______, _______,  _______, _______, _______,
