...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT_arrow(
    ...
    KC_LGUI,    MOVE,  KC_LALT,              LW_X(ENT),    RS_X(SPC),        KC_BSPC, KC_QUOT, KC_RCTL, KC_RALT
  ),
  ...
  [_LOWER] = LAYOUT_arrow(
    ...
    KC_CAPS, V_ALTB,  XX_TAB,   W_SNIP,   KC_F5,   KC_F3,    KC_LEFT,  KC_DOWN,  KC_UP,   KC_RGHT,  KC_PIPE, _______,
    _______, KC_MEH,  KC_HYPR,  _______,  _______, TOP,      BOTTOM,   KC_HOME,  KC_END,  _______,  _______, _______,
  ...
  [_SYSTEM] = LAYOUT_arrow(
    QK_BOOT, _______, _______,  _______,  _______,  _______,  _______,  _______,  _______, KC_SYRQ,  KC_SCRL, KC_BRK,
