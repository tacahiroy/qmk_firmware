...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_arrow(
    ...
    _______, _______, _______,  _______,    _______,    _______,    _______,    _______,    SK_KANA, _______,  _______, _______,
  ...
  [_MOVE] = LAYOUT_arrow(
    M_EXPS,  _______, _______,  _______,    _______,    _______,    V_ALTB,     TM_PREV,    _______, TM_NEXT,  _______, _______,
    MOUS,    A(KC_1), A(KC_2),  A(KC_3),    A(KC_4),    A(KC_5),    KC_LEFT,    KC_DOWN,    KC_UP,   KC_RGHT,  A(KC_9), _______,
