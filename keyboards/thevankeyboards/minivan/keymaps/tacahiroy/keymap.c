...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT_arrow(
    ...
    KC_LSFT,    MO_X(Z), KC_X,    KC_C,    KC_V,    KC_B,    KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
  ...
  [_MOVE] = LAYOUT_arrow(
    ...
    _______, A(KC_1), A(KC_2),  A(KC_3),    A(KC_4),    A(KC_5),    KC_MS_L,    KC_MS_D,    KC_MS_U, KC_MS_R,  TM_SSH,  KC_PIPE,
    _______, _______, _______,  _______,    _______,    _______,    _______,    KC_BTN1,    KC_BTN2, _______,  _______, _______,
    _______, _______, _______,                          _______,    _______,                _______, _______,  _______, _______
  ),

  [_MOUS] = LAYOUT_arrow(
    _______, KC_F1,   KC_F2,    KC_F3,      KC_F4,      KC_F5,      _______,    _______,    _______, _______,  _______, KC_MPLY,
    _______, KC_F6,   KC_F7,    KC_F8,      KC_F9,      KC_F10,     _______,    _______,    _______, _______,  KC_VOLD, KC_VOLU,
    _______, _______, _______,  _______,    KC_F11,     KC_F12,     _______,    _______,    _______, _______,  _______, QK_BOOT,
    _______, _______, _______,                          _______,    _______,                _______, _______,  _______, _______
  ),
