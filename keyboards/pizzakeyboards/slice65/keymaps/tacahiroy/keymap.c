...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT(
        ...
        KC_LGUI, KC_LALT, LOWER,                     KC_SPC,                            RAISE,   KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    [_LOWER] = LAYOUT(
        W_IME,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_MPLY,
        ...
        _______, _______, CUT,     COPY2,   PASTE,   TOP,     BOTTOM,  KC_HOME, KC_END,  _______, TM_LSTS, _______,          TOP,     _______,
        _______, _______, _______,                   JP_HENK,                            _______, _______,          KC_HOME, BOTTOM,  KC_END    
    ),

    [_RAISE] = LAYOUT(
        QK_BOOT, _______, _______, _______, _______, _______, WS_LEFT, WS_RGHT, _______, _______, _______, _______, _______, XX_WIN,  _______,
