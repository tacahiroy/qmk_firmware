...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_60_tsangan_hhkb(
    ...
    _______, KC_MPLY, MOUS,    _______, _______, _______, _______, KC_PGDN, KC_PGUP, KC_BSLS, TM_SSH,  _______, _______,
  ...
  [_RAISE] = LAYOUT_60_tsangan_hhkb(
    ...
    _______, KC_MPLY, KC_EQL,  W_SNIP,  KC_F5,   KC_F3,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, _______,
