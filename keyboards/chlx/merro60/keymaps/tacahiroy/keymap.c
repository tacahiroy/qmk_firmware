...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_60_tsangan_hhkb(
    ...
    W_WLST,  _______, XX_TAB,  KC_MEH,  KC_CAPS, _______, SK_KANA, FX_PREV, _______, FX_NEXT, KC_PIPE, _______, _______,  KC_DEL,
  ...
  [_ADJUST] = LAYOUT_60_tsangan_hhkb(
    QK_BOOT, TEN_U,   EPRM,    _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_SYRQ, KC_SCRL, KC_BRK,
