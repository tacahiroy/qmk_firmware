 ...
 *
 * Copyright 2023-2026 YOSHIHARA Takahiro <tacahiroy@gmail.com>
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_60_tsangan_hhkb(
    ...
    W_WLST,  _______, XX_TAB,  KC_MEH,  KC_CAPS, _______, JP_HENK, TM_PREV, TM_WLST, TM_NEXT, KC_PIPE, _______, _______,  _______,
    _______, KC_MPLY, MOUS,    W_SNIP,  _______, _______, _______, KC_PGDN, KC_PGUP, KC_BSLS, TM_SSH,  JP_MHEN, _______,
    _______, _______, CUT,     COPY2,   PASTE2,  TOP,     BOTTOM,  KC_HOME, KC_END,  _______, _______, _______, KC_PGUP,
    _______, _______, _______,                   SK_KANA,                            _______, _______, _______ 
  ),
  ...
  [_RAISE] = LAYOUT_60_tsangan_hhkb(
    ...
    AHK_ATB, AHK_MOB, XX_TAB,  _______, KC_LPRN, KC_LBRC, KC_RBRC, KC_RPRN, KC_ASTR, FX_NEXT, _______, KC_VOLD, KC_VOLU, _______,
