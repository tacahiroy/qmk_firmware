...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
    KC_GRV,   _______,  _______,  _______,  _______,  _______,  _______, _______,  C_LEFT,   C_RIGHT,  _______,  _______,  _______,  _______,  KC_CAPS,  _______,
    ...
    _______,  _______,  _______,  _______,  _______,  TOP,               BOTTOM,   KC_HOME,  KC_END,   _______,  _______,  KC_CAPS,            TOP,
    _______,            _______,            _______,  _______,           JP_HENK,  _______,                                          KC_HOME,  BOTTOM,   KC_END
  ),

  [_RAISE] = LAYOUT(
    _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    _______, KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   _______, QK_BOOT,
