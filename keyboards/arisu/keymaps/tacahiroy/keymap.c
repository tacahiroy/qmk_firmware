...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT(
    ...
    KC_LGUI,         KC_LALT,         LOWER,  KC_BSPC,         RS_X(SPC),  RAISE,                     KC_LEFT,  KC_DOWN,      KC_RGHT
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    MC_EXPS,  _______,  W_SSHOT,  KC_MS_U,  _______,  KC_ESC,            V_ALTB,   TM_PREV,  KC_BSPC,  TM_NEXT,  KC_PIPE,  _______,  KC_MPRV,  KC_MNXT,  KC_VOLU,
    KC_CAPS,  _______,  KC_MS_L,  KC_MS_D,  KC_MS_R,  MOUS,              KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  TM_SSH,   KC_ESC,   _______,            KC_VOLD,
