...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_CAPS,  KC_ESC,   MOUS,     W_SSHOT,  KC_F5,    KC_F3,             KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  TM_SSH,   _______,  _______,            KC_VOLD,
  ...
  [_RAISE] = LAYOUT(
    _______,  _______,  _______,  KC_F3,    _______,  KC_F5,    _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,  XX_WIN,  QK_BOOT,
