...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_65_ansi_blocker(
        ...
        AHK_ATB, AHK_MOB, XX_TAB,  _______, KC_LPRN, KC_LBRC, KC_RBRC, KC_RPRN, KC_DEL,  FX_NEXT, _______, KC_VOLD, KC_VOLU, KC_MPLY,   _______,
        _______, _______, KC_EQL,  KC_PLUS, KC_F5,   KC_F3,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______, _______,            _______,
