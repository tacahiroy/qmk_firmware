...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT_alice(
    ...
    KC_PGDN, KC_LCTL, KC_A,    KC_R,    KC_S,    KC_T,    KC_D,             KC_H,    KC_N,   KC_E,    KC_I,    KC_O,    KC_QUOT,          KC_ENT,
             KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,             KC_LGUI, KC_K,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_DEL,
  ...
  [_LOWER] = LAYOUT_alice(
    ...
    _______, _______, _______, _______, W_IME,   _______, TOP,              V_ALTB,  TM_PREV, KC_BSPC, TM_NEXT, _______, KC_LCBR, KC_RCBR, KC_PIPE,
    _______, _______, _______, _______, W_SSHOT, MOUS,    _______,          KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, TM_SSH,  _______,          _______,
             _______, W_QUIT,  _______, _______, _______, BOTTOM,           _______, KC_HOME, KC_END,  _______, _______, TM_LSTS, _______, _______,
  ...
  [_RAISE] = LAYOUT_alice(
    ...
    _______, _______, _______, KC_EQL,  KC_PLUS, KC_LPRN, KC_LBRC,          KC_RBRC, KC_RPRN, KC_DEL,  KC_BSLS, _______, _______,          _______,
             _______, KC_UNDS, CUT,     COPY2,   PASTE2,  KC_LCBR,          KC_RCBR, KC_RCBR, KC_PGUP, KC_PGDN, _______, _______, _______, _______,
             _______,          _______, _______, _______,                            _______,          _______,                            _______
  ),
