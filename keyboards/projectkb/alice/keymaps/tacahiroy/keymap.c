...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT_alice(
    ...
    KC_PGDN, CTL_X(ESC), KC_A, KC_R, KC_S,    KC_T,  KC_D,            KC_H,      KC_N,  KC_E, KC_I,    KC_O,    KC_QUOT,          KC_ENT,
             KC_LSFT,    KC_Z, KC_X, KC_C,    KC_V,  KC_B,            KC_K,      KC_K,  KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_MPLY,
  ...
  [_LOWER] = LAYOUT_alice(
    ...
    KC_VOLU, M_EXPS,  XX_WIN,  XX_TAB,  KC_MS_U, W_SSHOT, KC_BTN1,           KC_BTN2, TM_PREV, KC_BSPC, TM_NEXT, KC_PIPE, _______, KC_LCBR, KC_RCBR,
