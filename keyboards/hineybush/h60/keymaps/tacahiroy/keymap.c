 ...
 *
 * Copyright 2024 Takahiro YOSHIHARA <tacahiroy@gmail.com>
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_60_tsangan_hhkb(
    ...
    W_WLST,  _______, XX_TAB,  _______, _______, _______, TM_SLST, TM_PREV, TM_WLST, TM_NEXT, KC_PIPE, KC_CAPS, _______, _______,
    _______, KC_MPLY, MOUS,    W_SNIP,  KC_F5,   KC_F3,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, TM_SSH,  KC_MINS, _______,
  ...
  [_RAISE] = LAYOUT_60_tsangan_hhkb(
    W_IME,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, XX_WIN,
    _______, _______, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, FX_NEXT, _______, _______, _______, _______,
  ...
  [_MOUS] = LAYOUT_60_tsangan_hhkb(
    QK_BOOT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_SYRQ, KC_SCRL, KC_BRK,
  ...
  [_ADJUST] = LAYOUT_60_tsangan_hhkb(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, CADEL,   _______, AC_TOGG, _______, DB_TOGG, HHKB,    _______, _______, _______, _______, _______, _______,
