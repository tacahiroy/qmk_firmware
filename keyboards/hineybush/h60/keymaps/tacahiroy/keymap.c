...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_HHKB] = LAYOUT_60_tsangan_hhkb(
    ...
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    SFTX(UP),   _______,
    _______,  _______,  _______,                                _______,                                CTLX(LEFT), ALTX(DOWN), GUIX(RGHT)
  ),
  ...
  [_LOWER] = LAYOUT_60_tsangan_hhkb(
    ...
    W_WLST,  _______, XX_TAB,  KC_MEH,  _______, _______, SK_KANA, TM_PREV, TM_WLST, TM_NEXT, KC_PIPE, KC_CAPS, CW_TOGG, _______,
