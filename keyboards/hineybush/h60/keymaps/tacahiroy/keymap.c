...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT_60_tsangan_hhkb(
    ...
    AHK_ATB, AHK_MOB, XX_TAB,  _______, _______, KC_LBRC, KC_RBRC, KC_AMPR, KC_ASTR, FX_NEXT, KC_BSLS, KC_VOLD, KC_VOLU, _______,
    _______, KC_MPLY, KC_EQL,  KC_PLUS, KC_F5,   KC_F3,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, TM_SSH,  _______, _______,
    _______, AHK_ZOM, AHK_MUT, COPY2,   PASTE2,  KC_LCBR, KC_RCBR, KC_HOME, KC_END,  _______, _______, _______, QK_BOOT,
    _______, _______, _______,                   _______,                            _______, _______, _______
  ),
