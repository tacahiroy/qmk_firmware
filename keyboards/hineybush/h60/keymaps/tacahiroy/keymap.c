/*
 * A QMK firmware keymap settings for hineybush/h60.
 *
 * Copyright 2024-2026 Takahiro YOSHIHARA <tacahiroy@gmail.com>
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_WKL60] = LAYOUT_60_tsangan_hhkb(
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_LGUI,
    KC_LALT,  _______,  LOWER,                        _______,                                          KC_RCTL,  _______,  KC_RALT
  ),

  [_TEN_U] = LAYOUT_60_tsangan_hhkb(
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_LGUI,
    KC_LALT,  LOWER,    XXXXXXX,                      _______,                                          XXXXXXX,  KC_RCTL,  KC_RALT
  ),
  ...
  [_LOWER] = LAYOUT_60_tsangan_hhkb(
    ...
    W_WLST,  _______, XX_TAB,  KC_MEH,  KC_CAPS, _______, SK_KANA, TM_PREV, TM_WLST, TM_NEXT, KC_PIPE, _______, _______,  KC_DEL,
  ...
  [_RAISE] = LAYOUT_60_tsangan_hhkb(
    ...
    _______, AHK_MOB, XX_TAB,  FX_PREV, FX_NEXT, KC_LBRC, KC_RBRC, TM_PREV, _______, TM_NEXT, _______, KC_VOLD, KC_VOLU, _______,
  ...
  [_MOUS] = LAYOUT_60_tsangan_hhkb(
    ...
    _______, _______, _______, _______, _______, _______, _______, MS_BTN1, _______, MS_BTN2, _______, KC_VOLD, KC_VOLU, _______,
    _______, _______, _______, _______, _______, _______, MS_LEFT, MS_DOWN, MS_UP,   MS_RGHT, TM_SSH,  _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______,                   _______,                            _______, _______, _______
  ),

  [_ADJUST] = LAYOUT_60_tsangan_hhkb(
    QK_BOOT, TEN_U,   EPRM,    _______, _______, _______, _______, _______, _______, _______, _______, KC_SYRQ, KC_SCRL, KC_BRK, _______,
