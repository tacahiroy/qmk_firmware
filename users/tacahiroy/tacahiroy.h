...
#define AHK_ATB  A(KC_NUM)    // Activates window switcher on the host side.
#define AHK_ZOM  S(KC_NUM)    // Activates the Zoom window on the host side. This is useful when the MobaXTerm RDP window is active.
#define AHK_MOB  LCA(KC_NUM)  // Activates the MobaXterm RDP window
